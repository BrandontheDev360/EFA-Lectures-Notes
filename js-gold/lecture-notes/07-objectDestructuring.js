...
// These two below is the same as above
// const guitars = instruments.guitars; 
...
function checkBrand(b, m) {
    if(b === 'Pearl' && m === 'Session Studio') {
        return true;
    } else {
        return false;
    }
}
console.log(checkBrand(drums.type[0].brand, drums.type[0].model))